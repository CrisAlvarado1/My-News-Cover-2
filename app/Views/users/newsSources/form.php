    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12 col-sm-8 col-md-7">
                ...
                <form action="<?= site_url('users/newsSources/save'); ?>" method="POST" class="form-inline mt-3" role="form" id="newsSourcesForm">
                    ...
                    <div class="form-group mt-3 pt-2 col-3">
                        <input type="submit" id="submitButton" class="btn btn-secondary" value="Save">
                    </div>
                </form>
            </div>
        </div>
